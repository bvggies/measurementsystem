      ...
      >
        {loading ? (
          ...
          <>
            ...
            {/* Pagination */}
            {totalPages > 1 && (
              <div className="px-6 py-4 border-t border-steel-light flex items-center justify-between">
                <button
                  onClick={() => setPage((p) => Math.max(1, p - 1))}
                  disabled={page === 1}
                  className="px-4 py-2 border border-steel-light text-steel rounded-lg disabled:opacity-50 hover:bg-soft-white transition-colors"
                >
                  Previous
                </button>
